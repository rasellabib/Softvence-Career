    ...
    <div>
      <div className="sce-padding">
        <div className="container">
          <div className="why-interested-sec">
            <div className="text-center">
              <h1>Interested In Working With Us?</h1>
              <h4 className="mt-16 text-black">
                We work with real estate investors across the country every day.
                How can we help?
              </h4>
            </div>
            <div className="interested-card-div">
              <div className="interested-card">
                <div className="interested-card-img-div">
                  <div className="interested-card-img">
                    <img src="./icon1.svg" alt="" />
                  </div>
                </div>
                <div>
                  <h5 className="card-title">Active Deal</h5>
                  <p className="font-normal-18">
                ...
                <div>
                  <button className="interested-btn">
                    ...
                    >
                      <path
                        d="M15.5599 0.0205078H6.39325C6.16294 0.0205078 5.97657 0.206905 5.97657 0.437256C5.97657 0.667599 6.16294 0.854003 6.39325 0.854003H14.554L1.09864 14.3115C0.935869 14.4743 0.935869 14.738 1.09864 14.9008C1.18001 14.9822 1.28665 15.0229 1.39325 15.0229C1.49985 15.0229 1.60645 14.9822 1.68786 14.9008L15.1433 1.44327V9.60532C15.1433 9.8357 15.3296 10.0221 15.5599 10.0221C15.7902 10.0221 15.9766 9.8357 15.9766 9.60532V0.437256C15.9766 0.206905 15.7902 0.0205078 15.5599 0.0205078Z"
                        fill="none"
                      />
                    </svg>
                  </button>
              ...
              <div className="interested-card">
                ...
                <div>
                  <h5 className="card-title">Pre-Approval</h5>
                  <p className="font-normal-18">
              ...
              <div className="interested-card">
                ...
                <div>
                  ...
                  <p className="font-normal-18">I’d like to schedule a call.</p>
                </div>
                <div>
                  <button className="interested-btn">
                    Find a home
